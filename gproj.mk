...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/root/init.gee.usb.rc:root/init.gee.usb.rc
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/conf/qosmgr_rules.xml:system/etc/qosmgr_rules.xml \
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/tools/kickstart_checker.sh:system/etc/kickstart_checker.sh \
    $(LOCAL_PATH)/tools/fetch-swv:system/bin/fetch-swv

# Prebuilt kl and kcm keymaps
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/input/hs_detect.kl:system/usr/keylayout/hs_detect.kl \
    $(LOCAL_PATH)/input/pmic8xxx_pwrkey.kl:system/usr/keylayout/pmic8xxx_pwrkey.kl \
    $(LOCAL_PATH)/input/hs_detect.kcm:system/usr/keychars/hs_detect.kcm \
    $(LOCAL_PATH)/input/pmic8xxx_pwrkey.kcm:system/usr/keychars/pmic8xxx_pwrkey.kcm
